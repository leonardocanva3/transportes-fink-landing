  ...
  return (
    <footer className="site-footer">
      <div className="footer-brand">
        ...
        <p>Transportes Fink — segurança, agilidade e compromisso.</p>
        <a href="https://www.transportesfink.com.br">www.transportesfink.com.br</a>
      </div>
      <div className="footer-contact">
        ...
        <a
          href="https://www.instagram.com/transportesfink/"
          target="_blank"
      ...
      <div className="footer-meta">
        ...
        <span>© {new Date().getFullYear()} Transportes Fink</span>
      </div>
    </footer>
  );
}
